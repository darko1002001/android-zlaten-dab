...
public class CoverFlow extends Gallery {
  ...
  public void setReflectionRatio(float reflectionRatio) {
    ...
    if (this.getAdapter() != null) {
      ((CoverFlowBaseAdapter) this.getAdapter()).notifyDataSetChanged();
    }
  }
  ...
  /**
   * Use this to provide a {@link CoverFlowBaseAdapter} to the coverflow. This
   * method will throw an {@link ClassCastException} if the passed adapter does not
   * subclass {@link CoverFlowBaseAdapter}.
   *
   * @param adapter
   */
  @Override
  public void setAdapter(SpinnerAdapter adapter) {
    if (!(adapter instanceof CoverFlowBaseAdapter)) {
      throw new ClassCastException(CoverFlow.class.getSimpleName() + " only works in conjunction with a " + CoverFlowBaseAdapter.class.getSimpleName());
    }
